...
void loop() {
  ...
  //******************************************************************************//
       ...
       switch(conf){
       case 1:
                pinos(UmPasso[Cpasso],IN1,IN4); //Envíe al puerto la información de la tabla
                passo=4;
                break;
       case 2:
                pinos(DoisPassos[Cpasso],IN1,IN4); //Envíe al puerto la información de la tabla
                passo=4;
                break;
       case 3:
                pinos(MeioPasso[Cpasso],IN1,IN4); //Envíe al puerto la información de la tabla
                passo=8;
                break;
       }
